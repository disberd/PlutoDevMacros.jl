...
NOTE: Now most of the functionality originally intended by `@only_in_nb` and `@only_out_nb` is directly achieavable in Pluto using the `skip_as_script` implemented in [this PR](https://github.com/fonsp/Pluto.jl/pull/2018).
